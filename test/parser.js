    ...
    context('Valid input', function() {
      ...
      context('Valid CSS Inherent', function() {
        it('should get a object without any error', function(done) {
          ...
          assert.deepEqual(result['any_element'], {
            "color": "red"
          });
          assert.deepEqual(result['parent__child'], {
            "color": "blue"
          });
          assert.deepEqual(result['parent__child2'], {
            "color": "blue"
          });
          assert.deepEqual(result['cat_blue'], {
            "color": "blue"
          });
      ...
      context('Valid CSS with Media Queries properties', function() {
        it('should get a object without any error', function(done) {
          ...
          assert.deepEqual(mediaFor1020['body__container'], {
          ...
          assert.deepEqual(mediaFor768['body__container'], {
          ...
          assert.deepEqual(mediaForPrint['body__container'], {
            width: '748px !important'
          });
      ...
      context('Valid CSS with a repeated media query', function() {
        it('should get a object with the values set in all settings', function(done) {
          ...
          assert.deepEqual(mediaQuery['nav'], {
            width: '200px !important'
          });
          assert.deepEqual(mediaQuery['section'], {
            width: '768px !important'
          });
          assert.deepEqual(mediaQuery['footer'], {
            width: '768px !important'
          });
